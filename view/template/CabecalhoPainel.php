...
<head>
    ...
    <link rel="stylesheet" href="/css/custom-painel.css">
...
<body>
    ...
    <nav class="navbar is-fixed-top" role="navigation" aria-label="main navigation" js-cabecalho>
        <?php include '../view/painel/includes/cabecalho.php'; ?>
    </nav>